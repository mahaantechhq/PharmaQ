-- Adds an expiry date alongside the existing drug license number, and
-- extends provision_business (0024_provision_business_type.sql) to accept
-- and store it on creation.

alter table businesses add column drug_license_expiry date;
